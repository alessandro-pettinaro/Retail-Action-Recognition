...
DIRECTORY = "FPV_Layer_4_B8_LR0.0001_ADAMW__LR0.0001_AGUMENTED"
STATE ="best"
...
os.makedirs(f"report/FPV/{TYPE}/Confusion_matrices/{DIRECTORY}_{STATE}", exist_ok=True)
plt.savefig(f"report/FPV/{TYPE}/Confusion_matrices/{DIRECTORY}_{STATE}/conf_matrix_{DIRECTORY}.png")
plt.close()
