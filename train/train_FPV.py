...
# ========== CONFIG ==========
VIEW_NAME = "FPV"
DATA_DIR = "/home/vrai/video-mamba/data/dataset_view/FPV"
...
NUM_WORKERS = 12
TRAIN_LAST_LAYERS = 4
EXPERIMENT_NAME = f"{VIEW_NAME}_Layer_{TRAIN_LAST_LAYERS}_B{BATCH_SIZE}_LR{LR}_ADAMW_{WEIGHT_DECAY}_AGUMENTED50"
...
best_val_acc = 0.0
ckpt_path = os.path.join("model/checkpoints", "best", EXPERIMENT_NAME , "best_model.pth")
...
last_model_path = os.path.join("model/checkpoints", "last", EXPERIMENT_NAME, "last_model.pth")
